...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  imageBlockUrl = imageBlockUrl.includes(".svg")? imageFallbackUrl: imageBlockUrl;
...
async function getCompatibleImageUrl(
  ...
  const image = (await isUrlReachable(url)) && !url?.includes(".svg")  ? url : fallbackUrl
